...
struct MyColors {
    ...
    init() {
        ...
        functionDisplayTextColor = Color(UIColor.blue)
        ...
        mainLongPressColor = Color(UIColor.blue)
        mainButtonTextColor = Color(UIColor.white)
        
        brightButtonColor = Color(UIColor.blue).opacity(0.75)
        brightShortPressColor = Color(UIColor.blue.lighter(by: 37.5))
        brightLongPressColor = Color(UIColor.blue.lighter(by: 37.5))
