...
class DataRouter: ObservableObject {
    ...
    let defaultButtonList = ["EE", "√x", "1/x", "%", "% ∆", "e ᵡ", "ln x", "y ᵡ", "SIN", "COS", "TAN", "ASIN", "ACOS", "ATAN", "π", "D→R", "R→D", "x!", "x√y", "log₁₀", "NPV", "IRR", "CASHF", "MEAN", "SDEV", "NPR", "CDF", "PDF", "NCR", "MAG8", "RAND", "DICE", "SINH", "COSH", "TANH", "e", "log₂", "2 ᵡ", "10 ᵡ"]
